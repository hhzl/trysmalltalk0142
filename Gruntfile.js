        ...
        amberc: {
            ...
            all: {
                src: [
                    ...
                    'src/TrySmalltalk-Tests.st' // list all tests in dependency order
                ],
            ...
            test_runner: {
                ...
                libraries: [
                    ...
                    'TrySmalltalk', /* add other code-to-test packages here */
                    'SUnit',
                    'TrySmalltalk-Tests' /* add other test packages here */
                ],
